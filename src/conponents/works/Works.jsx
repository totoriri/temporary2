...
const Works = () => {
    return (
        <div id="works_container">
            ...
            <WorksItemLeft url="https://brave-mayer-82fc7b.netlify.com/" img={mindPerch} title="mindPerch" description="A app of searching picture books that match the user's mood. The best thing about this app is the theme color changes depending on the mood the user chooses." languages={langObj.mindPerch}/>
            <WorksItemRight url="https://vigorous-visvesvaraya-70500e.netlify.com/" img={Brickhouse} title="Team project" description="A website of a venture company that invest in early stage sports and entertaiment technology companies. My role was coding this in React and Sass and giving a presentation to the client. " languages={langObj.Brickhouse} />
            <div className="works_item reverse_work_item">
                ...
                <a href=""><img className="react_img" src={React_img} alt="works_img" /></a>
            </div>
        </div>
    )
}
