...
const Works = () => {
    return (
        <div id="works_container">
            ...
            <WorksItemLeft url="https://brave-mayer-82fc7b.netlify.com/" git="https://github.com/totoriri/book-context-final-version" img={mindPerch} title="mindPerch" description="A app of searching picture books that match the user's mood." languages={langObj.mindPerch}/>
            <WorksItemRight url="https://vigorous-visvesvaraya-70500e.netlify.com/" git="https://github.com/ShotaTogawa/Brickhouse-shcool-project" img={Brickhouse} title="Team project" description="A website of a venture company that invests in early stage sports and entertaiment technology companies. My role was coding React and Sass and giving a presentation to the client. " languages={langObj.Brickhouse} />
            <div className="works_item reverse_work_item">
                <div className="works-descrition">
                    ...
                    <CountDown targetDate="June 30, 2020" targetTime="18:00:00" />
                </div>
